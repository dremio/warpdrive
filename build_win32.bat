...
if NOT DEFINED ARROW_GIT_TAG SET ARROW_GIT_TAG="89f9a0948961f6e94f1ef5e4f310b707d22a3c11"
if NOT DEFINED ODBCABSTRACTION_REPO SET ODBCABSTRACTION_REPO="../flightsql-odbc"
if NOT DEFINED ODBCABSTRACTION_GIT_TAG SET ODBCABSTRACTION_GIT_TAG="6b27a3524fcd26a5ea69d08b8999215713544b02"
