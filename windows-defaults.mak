...
#
!IF "$(TARGET_CPU)" == "x86"
WD_INC=C:\Program Files (x86)\PostgreSQL\9.6\include
WD_LIB=C:\Program Files (x86)\PostgreSQL\9.6\lib
!ELSE
WD_INC=$(PROGRAMFILES)\PostgreSQL\9.6\include
WD_LIB=$(PROGRAMFILES)\PostgreSQL\9.6\lib
!ENDIF
