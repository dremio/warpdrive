...
function(FIND_CLANG_TOOL NAME OUTPUT VERSION_CHECK_PATTERN)
  ...
  find_program(CLANG_TOOL_BIN
               NAMES ${NAME}-${WARPDRIVE_CLANG_TOOLS_VERSION}
                     ${NAME}-${WARPDRIVE_CLANG_TOOLS_VERSION_MAJOR}
...
string(REGEX REPLACE "\\." "\\\\." WARPDRIVE_CLANG_TOOLS_VERSION_ESCAPED
                     "${WARPDRIVE_CLANG_TOOLS_VERSION}")

find_clang_tool(clang-tidy CLANG_TIDY_BIN
                "LLVM version ${WARPDRIVE_CLANG_TOOLS_VERSION_ESCAPED}")
if(CLANG_TIDY_BIN)
...
find_clang_tool(clang-format CLANG_FORMAT_BIN
                "^clang-format version ${WARPDRIVE_CLANG_TOOLS_VERSION_ESCAPED}")
if(CLANG_FORMAT_BIN)
