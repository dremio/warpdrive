...
namespace {
  ...
  std::string GetTodayDate() {
    ...
    result << "y: " << date.tm_year + 1900 << " m: " << date.tm_mon + 1 << " d: " << date.tm_mday;
...
{ std::make_tuple("1234567890", "bigint", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("12345", "integer", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("1234567", "integer", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("'2011-02-13'", "date", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("'13:23:34'", "time", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("'13:23:34'", "time", "SQL_C_TYPE_TIMESTAMP"), GetTodayDate() + " h: 13 m: 23 s: 34 f: 0" },
...
{ std::make_tuple("'2011-02-15 15:49:18'", "timestamp", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("1234.567890", "decimal", "SQL_C_BIT"), "1" },
...
{ std::make_tuple("1234.567890", "numeric", "SQL_C_BIT"), "1" },
	...
	::testing::Combine(
		...
		::testing::ValuesIn(
			std::vector {
				std::pair<int, std::string>(SQL_C_CHAR, "SQL_C_CHAR"),
				std::pair<int, std::string>(SQL_C_WCHAR, "SQL_C_WCHAR"),
				// std::pair<int, std::string>(SQL_C_BINARY, "SQL_C_BINARY"), // TODO: Fix Time to Binary conversion
				std::pair<int, std::string>(SQL_C_TYPE_TIME, "SQL_C_TYPE_TIME"),
				std::pair<int, std::string>(SQL_C_TYPE_TIMESTAMP, "SQL_C_TYPE_TIMESTAMP"),
			}
		)
	...
	::testing::Combine(
		...
		::testing::ValuesIn(
			std::vector {
				std::pair<int, std::string>(SQL_C_CHAR, "SQL_C_CHAR"),
				std::pair<int, std::string>(SQL_C_WCHAR, "SQL_C_WCHAR"),
				// std::pair<int, std::string>(SQL_C_BINARY, "SQL_C_BINARY"), // TODO: Fix Timestamp to Binary conversions
				std::pair<int, std::string>(SQL_C_TYPE_DATE, "SQL_C_TYPE_DATE"),
				std::pair<int, std::string>(SQL_C_TYPE_TIME, "SQL_C_TYPE_TIME"),
				std::pair<int, std::string>(SQL_C_TYPE_TIMESTAMP, "SQL_C_TYPE_TIMESTAMP"),
			}
