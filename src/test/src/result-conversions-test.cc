...
{ std::make_tuple("1234.567890", "decimal", "SQL_C_CHAR"), "1234.567890" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_WCHAR"), "1234.567890" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_SSHORT"), "1234" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_USHORT"), "1234" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_SLONG"), "1234" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_ULONG"), "1234" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_FLOAT"), "1234.567871" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_DOUBLE"), "1234.567890" },
...
{ std::make_tuple("1234.567890", "decimal", "SQL_C_SBIGINT"), "1234" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_UBIGINT"), "1234" },
{ std::make_tuple("1234.567890", "decimal", "SQL_C_BINARY"), "SQLGetData failed" },
...
{ std::make_tuple("1234.567890", "decimal", "SQL_C_NUMERIC"), "precision: 10 scale: 6 sign: 6 val: d2029649000000000000000000000000" },
...
// INSTANTIATE_TEST_SUITE_P(Template, ResultConversionsTest,
// 	::testing::Combine(
//     	::testing::ValuesIn(
// 	 		std::vector {
// 	 		}
...
// INSTANTIATE_TEST_SUITE_P(Boolean, ResultConversionsTest,
// 	::testing::Combine(
//     	::testing::ValuesIn(
// 	 		std::vector {
...
// INSTANTIATE_TEST_SUITE_P(Varbinary, ResultConversionsTest,
// 	::testing::Combine(
//     	::testing::ValuesIn(
// 	 		std::vector {
...
// INSTANTIATE_TEST_SUITE_P(CharAndVarchar, ResultConversionsTest,
// 	::testing::Combine(
//     	::testing::ValuesIn(
// 	 		std::vector {
...
// INSTANTIATE_TEST_SUITE_P(Integers, ResultConversionsTest,
// 	::testing::Combine(
//     	::testing::ValuesIn(
// 	 		std::vector {
...
// INSTANTIATE_TEST_SUITE_P(Varchar, ResultConversionsTest,
// 	::testing::Combine(
//     	::testing::ValuesIn(
// 	 		std::vector {
