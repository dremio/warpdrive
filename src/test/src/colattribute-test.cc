...
TEST_P(SQLColAttributeTest, ColAttributeTestWithExtraConnOptions) {
    ...
    std::vector<SQLULEN> expected_data_types_odbc_v2 = {SQL_INTEGER, SQL_VARCHAR, SQL_VARCHAR, SQL_VARCHAR, SQL_VARCHAR, SQL_TIMESTAMP, SQL_VARCHAR};
    std::vector<SQLULEN> expected_data_types_odbc_v3 = {SQL_INTEGER, SQL_VARCHAR, SQL_VARCHAR, SQL_VARCHAR, SQL_VARCHAR, SQL_TYPE_TIMESTAMP, SQL_VARCHAR};

    std::vector<SQLLEN> expected_concise_types = {SQL_INTEGER, SQL_VARCHAR, SQL_VARCHAR, SQL_VARCHAR, SQL_VARCHAR, SQL_TYPE_TIMESTAMP, SQL_VARCHAR};
