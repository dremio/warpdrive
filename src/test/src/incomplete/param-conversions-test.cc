...
int main(int argc, char **argv)
{
	...
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "2");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "-2");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "2");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "-2");
	TEST_CONVERT("SELECT 2.2 > ?", SQL_C_CHAR, SQL_FLOAT, (SQLPOINTER) "2.3");
	TEST_CONVERT("SELECT 3.3 > ?", SQL_C_CHAR, SQL_DOUBLE, (SQLPOINTER) "3.01");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_CHAR, (SQLPOINTER) "5 escapes: \\ and '");

	/* test boundary cases */
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "32767");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "-32768");
	...
	TEST_CONVERT("SELECT '555' > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "6");
	TEST_CONVERT("SELECT '555' > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "6");
	TEST_CONVERT("SELECT '555' > ?", SQL_C_CHAR, SQL_CHAR, (SQLPOINTER) "6");
	 ...
	 * test.
	 */
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "99999999999999999999999");

	printf("\nTesting conversions with invalid values...\n");

	TEST_CONVERT("SELECT 2 > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "2, 'injected, BAD!'");
	TEST_CONVERT("SELECT 2 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "2, 'injected, BAD!'");
	TEST_CONVERT("SELECT 1.3 > ?", SQL_C_CHAR, SQL_FLOAT, (SQLPOINTER) "3', 'injected, BAD!', '1");
	TEST_CONVERT("SELECT 1.4 > ?", SQL_C_CHAR, SQL_FLOAT, (SQLPOINTER) "4 \\'bad', '1");
	TEST_CONVERT("SELECT 1-?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "-1");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "-");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_INTEGER, (SQLPOINTER) "");
	TEST_CONVERT("SELECT 1-?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "-1");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "-");
	TEST_CONVERT("SELECT 1 > ?", SQL_C_CHAR, SQL_SMALLINT, (SQLPOINTER) "");
	...
	TEST_CONVERT("SELECT ?", SQL_C_CHAR, SQL_BINARY, (SQLPOINTER) "666f6f0001");
	TEST_CONVERT("SELECT ?::text", SQL_C_BINARY, SQL_CHAR, byteaparam);

	printf("\nTesting datetime conversions\n");
	TEST_CONVERT("SELECT ?", SQL_C_CHAR, SQL_TIMESTAMP, (SQLPOINTER) "04-22-2011 01:23:45");
	TEST_CONVERT("SELECT ?", SQL_C_CHAR, SQL_TIMESTAMP, (SQLPOINTER) "{ts '2011-04-22 01:23:45'}");
	TEST_CONVERT("SELECT ?", SQL_C_CHAR, SQL_TIME, (SQLPOINTER) "{t '01:23:45'}");
	TEST_CONVERT("SELECT ?", SQL_C_CHAR, SQL_DATE, (SQLPOINTER) "{d '2011-04-22'}");
