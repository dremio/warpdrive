...
TEST_F(SQLStatementFunctionsTest, TestExecDirectNormalFlow){
  ...
  std::string err_msg;
  std::string exp_result = "50\tCustomer#000000050\t9SzDYlkzxByyJ1QeTI o\t6\t16-658-112-3221\t4266.130000\tMACHINERY \tts. furiously ironic accounts cajole furiously slyly ironic dinos.\n"
                           "51\tCustomer#000000051\tuR,wEaiTvo4\t12\t22-344-885-4251\t855.870000\tFURNITURE \teposits. furiously regular requests integrate carefully packages. furious\n"
                           "52\tCustomer#000000052\t7 QOqGqqSy9jfV51BC71jcHJSD0\t11\t21-186-284-5998\t5630.280000\tHOUSEHOLD \tic platelets use evenly even accounts. stealthy theodolites cajole furiou\n"
                           "53\tCustomer#000000053\tHnaxHzTfFTZs8MuCpJyTbZ47Cm4wFOOgib\t15\t25-168-852-5363\t4113.640000\tHOUSEHOLD \tar accounts are. even foxes are blithely. fluffily pending deposits boost\n"
                           "54\tCustomer#000000054\t,k4vf 5vECGWFy,hosTE,\t4\t14-776-370-4745\t868.900000\tAUTOMOBILE\tsual, silent accounts. furiously express accounts cajole special deposits. final, final accounts use furi\n";
