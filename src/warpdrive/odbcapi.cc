		   ...
		   SQLLEN *StrLen_or_Ind)
{
	RETCODE	ret;
        return ODBCStatement::ExecuteWithDiagnostics(StatementHandle, [&] {
          MYLOG(0, "Entering\n");
          ret = WD_BindCol(StatementHandle, ColumnNumber, TargetType, TargetValue,
		   ...
		   SQLCHAR *Authentication, SQLSMALLINT NameLength3)
{
	RETCODE	ret;
        return ODBCConnection::ExecuteWithDiagnostics(ConnectionHandle, [&] {
          MYLOG(0, "Entering\n");
          ret = WD_Connect(ConnectionHandle, ServerName, NameLength1, UserName,
...
{
	RETCODE	ret;
        return ODBCConnection::ExecuteWithDiagnostics(hdbc, [&] {
          ConnectionClass *conn = (ConnectionClass *)hdbc;

          MYLOG(0, "Entering\n");
          ret = WD_DriverConnect(hdbc, hwnd, szConnStrIn, cbConnStrIn, szConnStrOut,
				 ...
				 SQLSMALLINT *pcbConnStrOut)
{
	...
	MYLOG(0, "Entering\n");
        return ODBCConnection::ExecuteWithDiagnostics(hdbc, [&] {
          ret = WD_BrowseConnect(hdbc, szConnStrIn, cbConnStrIn, szConnStrOut,
			   ...
			   SQLSMALLINT *DecimalDigits, SQLSMALLINT *Nullable)
{
	...
	MYLOG(0, "Entering\n");
        return ODBCStatement::ExecuteWithDiagnostics(StatementHandle, [&] {
          ret = WD_DescribeCol(StatementHandle, ColumnNumber, ColumnName,
		   ...
		   SQLLEN *StrLen_or_Ind)
{
	RETCODE	ret;
        ...
        return ODBCStatement::ExecuteWithDiagnostics(StatementHandle, [&] {
          MYLOG(0, "Entering\n");
          ret = WD_GetData(StatementHandle, ColumnNumber, TargetType, TargetValue,
                           BufferLength, StrLen_or_Ind);
          return ret;
              });
}
		   ...
		   SQLSMALLINT BufferLength, SQLSMALLINT *StringLength)
{
  return ODBCConnection::ExecuteWithDiagnostics(ConnectionHandle, [&] {
    RETCODE ret;
    MYLOG(0, "Entering\n");
    ret = WD_GetInfo(ConnectionHandle, InfoType, InfoValue, BufferLength,
                     StringLength, FALSE);
    return ret;
        });
}
			   ...
			   SQLSMALLINT DataType)
{
	CSTR func = "SQLGetTypeInfo";
        return ODBCConnection::ExecuteWithDiagnostics(StatementHandle, [&] {
          RETCODE ret;
				  ...
				  SQLUSMALLINT Nullable)
{
	...
	RETCODE	ret;
        ODBCStatement::ExecuteWithDiagnostics(StatementHandle, [&] {
          throw DriverException("Unsupported function");
                });
}
/*
SQLCHAR *ctName = CatalogName, *scName = SchemaName, *tbName = TableName;
