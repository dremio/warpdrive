...
char *wcs_to_utf8(const UInt2 *wcsstr, SQLLEN ilen, SQLLEN *olen, BOOL lower_identifier);
char	*ucs2_to_utf8(const UInt2 *ucs2str, SQLLEN ilen, SQLLEN *olen, BOOL tolower);
SQLULEN	utf8_to_ucs2_lf(const char * utf8str, SQLLEN ilen, BOOL lfconv, UInt2 *ucs2str, SQLULEN buflen, BOOL errcheck);
...
SQLLEN locale_to_UInt2(UInt2 *utf16, const char *ldt, size_t n, BOOL lf_conv);
